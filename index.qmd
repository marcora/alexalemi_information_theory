...
$H_1 = \text{die is loaded, shows 6 1/3 of the times}$

$H_2 = \text{die is not loaded}$

$D : \text{die shows 6} \rightarrow 10\log_{10}\frac{P(D \mid H_1)}{P(D \mid H_2)} = 10\log_{10}\frac{\frac{1}{3}}{\frac{1}{6}} = 10\log_{10}(2) \approx 3\ \text{dB}$

$D : \text{die shows 1, 2, 3, 4, or 5} \rightarrow 10\log_{10}\frac{P(D \mid H_1)}{P(D \mid H_2)} = 10\log_{10}\frac{\frac{2}{3}}{\frac{5}{6}} = 10\log_{10}(0.8) \approx -1\ \text{dB}$

$\text{If we observe 1, 4, 6, 6} \rightarrow \text{weight of evidence} = -1 + (-1) + 3 + 3 = 4\ \text{dB}$
