...
$$\mathcal{I}(X;Y) \equiv \sum_{x, y} p(x,y) \cdot \log \frac{p(x,y)}{p(x) p(y)}$$
...
Minimize the "distance/difference" (KL divergence) between the real world $p(x)$ and your model of the world $q(x)$:
