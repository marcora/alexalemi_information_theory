...
Suppose we have two hypotheses about a coin ($H = \text{heads}, T = \text{tails}$):
...
$$\boxed{P(H_1\mid HH)\approx 0.31}$$
...
$$\boxed{P(H_0\mid HH)\approx 0.69}$$
...
Suppose the significance threshold is
...
Now suppose the study has **20% statistical power**, representative of [the low levels of statistical power reported in many neuroscientific studies](https://www.nature.com/articles/nrn3475).
...
Suppose we obtain a statistically significant result:
...
The significance threshold remains
...
Again, suppose we obtain a statistically significant result:
